...
package org.wso2.carbon.device.mgt.iot.virtualfirealarm.api;
...
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.dto.SensorRecord;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.listener.VirtualFirealarmSecurityManager;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.constants.VirtualFireAlarmConstants;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.config.xmpp.XmppAccount;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.config.xmpp.XmppConfig;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.config.xmpp.XmppServerClient;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.util.VirtualFireAlarmServiceUtils;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.util.ZipArchive;
import org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.util.ZipUtil;
...
public class VirtualFireAlarmServiceImpl implements VirtualFireAlarmService {
    ...
    public Response downloadSketch(@QueryParam("deviceName") String deviceName,
        ...
        try {
            ...
            log.error(ex.getMessage(), ex);
            return Response.status(500).entity(ex.getMessage()).build();
        } catch (VirtualFireAlarmException ex) {
            log.error(ex.getMessage(), ex);
            return Response.status(500).entity(ex.getMessage()).build();
        }
    }
    ...
    private ZipArchive createDownloadFile(String owner, String deviceName, String sketchType)
            throws DeviceManagementException, APIManagerException, JWTClientException,
                   UserStoreException, VirtualFireAlarmException {
