...
public class XmppServerClient {
    ...
    public static boolean createAccount(XmppAccount xmppAccount) throws VirtualFireAlarmException {
            ...
            if (xmppAccount != null) {
                try {
                    ...
                    if (e.getXMPPError().getCode() == 409) {
                        ...
                        throw new VirtualFireAlarmException(
                                "XMPP account creation failed. Error: " + e.getLocalizedMessage(), e);
                    }
                }
            } else {
                throw new VirtualFireAlarmException("Invalid XMPP attributes");
            }
        } else {
            return true;
        }
