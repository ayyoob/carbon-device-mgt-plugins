...
public class VirtualFireAlarmUtils {
    ...
    public static void setupMqttInputAdapter() throws IOException {
        ...
        try {
            ...
            APIUtil.getInputEventAdapterService()
    ...
    public static void destroyMqttInputAdapter() {
        if (!MqttConfig.getInstance().isEnabled()) {
            return;
        }
        try {
            ...
            PrivilegedCarbonContext.getThreadLocalCarbonContext().setTenantDomain(
                    VirtualFireAlarmConstants.DEVICE_TYPE_PROVIDER_DOMAIN, true);
            APIUtil.getInputEventAdapterService().destroy(VirtualFireAlarmConstants.MQTT_ADAPTER_NAME);
        } finally {
            PrivilegedCarbonContext.endTenantFlow();
        }
    }
    ...
    private static InputEventAdapterConfiguration createMqttInputEventAdapterConfiguration(String name, String type,
        ...
        mqttAdapterProperties.put(VirtualFireAlarmConstants.CONTENT_TRANSFORMATION, "default");
    ...
    public static PublicKey getDevicePublicKey(String alias) throws VirtualFireAlarmException {
        ...
        try {
            CertificateManagementService certificateManagementService =
                    APIUtil.getCertificateManagementService();
    ...
    public static boolean publishToDAS(String deviceId, float temperature) {
        EventsPublisherService deviceAnalyticsService = APIUtil.getEventsPublisherService();
    ...
    public static void destroyXmppInputAdapter() {
        if (!XmppConfig.getInstance().isEnabled()) return;try {
            PrivilegedCarbonContext.startTenantFlow();
            PrivilegedCarbonContext.getThreadLocalCarbonContext().setTenantDomain(
                    VirtualFireAlarmConstants.DEVICE_TYPE_PROVIDER_DOMAIN, true);
            APIUtil.getInputEventAdapterService().destroy(VirtualFireAlarmConstants.XMPP_ADAPTER_NAME);
        } finally {
            PrivilegedCarbonContext.endTenantFlow();
        }
    }
