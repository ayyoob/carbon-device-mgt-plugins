package org.wso2.carbon.device.mgt.iot.virtualfirealarm.api.util;
...
public class APIUtil {
	...
	public static EventsPublisherService getEventsPublisherService() {
		PrivilegedCarbonContext ctx = PrivilegedCarbonContext.getThreadLocalCarbonContext();
	...
	public static CertificateManagementService getCertificateManagementService() {
		...
		CertificateManagementService certificateManagementService =
				(CertificateManagementService) ctx.getOSGiService(CertificateManagementService.class, null);
		if (certificateManagementService == null) {
			String msg = "certificate management service has not initialized.";
			log.error(msg);
			throw new IllegalStateException(msg);
		}
	...
	public static InputEventAdapterService getInputEventAdapterService() {
		...
		InputEventAdapterService inputEventAdapterService =
				(InputEventAdapterService) ctx.getOSGiService(InputEventAdapterService.class, null);
		if (inputEventAdapterService == null) {
			String msg = "input event adapter service has not initialized.";
			log.error(msg);
			throw new IllegalStateException(msg);
		}
